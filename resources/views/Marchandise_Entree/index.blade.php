...
@section('dashboard')
<script src="{{asset("public/js/MarchandiseEntree/script.js")}}"></script>

<script>
    var csrf_token                                           = "{{csrf_token()}}";
    var AddProduitInTmpMarchandiseEntree                     = "{{url('AddProduitInTmpMarchandiseEntree')}}";
    var UpdateProduct                                        = "{{url('UpdateProduct')}}";
    var ListOrigin                                           = "{{url('ListOrigin')}}";
    var GetDataTmpMarchandiseEntree                          = "{{url('GetDataTmpMarchandiseEntree')}}";
    var TrashTmpMarchandiseEntreByProduct                    = "{{url('TrashTmpMarchandiseEntreByProduct')}}";
    var UpdateTmpMarchandiseQuantityURL                      = "{{url('UpdateTmpMarchandiseQuantityURL')}}";
    var StoreMarchandiseEntree                               = "{{url('StoreMarchandiseEntree')}}";
    var MarchandisEntre                                      = "{{url('MarchandisEntre')}}";
    var GetDataMarchandiseEntree                             = "{{url('GetDataMarchandiseEntree')}}";
    var DeleteMarchandiseEntree                              = "{{url('DeleteMarchandiseEntree')}}";
...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-bold m-0 text-center text-uppercase">Entrée de marchandises </h4>
                </div>
                
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Apps</a></li>
                        <li class="breadcrumb-item active"> Entrée de marchandises</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class=" mb-3">
                                <button class="btn btn-primary" style="margin-right: 5px" data-bs-toggle="modal" data-bs-target="#ModalAddMarchandiseEntree">Ajouter opération</button>
                            ...
                            <div class="table-responsive">
                                <div class="datatable-wrapper datatable-loading no-footer sortable fixed-height fixed-columns">
                                    ...
                                    <div class="datatable-container" style="height: 665.531px;">
                                        <table class="table datatable datatable-table Table_Marchandis_Entree" >
                                            <thead>
                                                <tr>
        ...
        <div class="modal fade" id="ModalAddMarchandiseEntree" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter un bon d'entrée de marchandise</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="pt-0">
                            <ul class="ValidationMarchandiseEntree"></ul>
                            <form id="FormAddMarchandiseEntree">
                                <div class="row ">
                                    ...
                                    <div class="col-md-12 col-12 d-flex justify-content-md-end justify-content-center mt-2 ">
                                        ...
                                        <button type="button" class="btn btn-primary mr-3" id="AddMarchandisEntree" style="margin-right: 5px">Sauvegarder</button>
                                        ...
                                        <button class="btn btn-success" id="AddInTmpMarchandiseEntree" style="max-height: 40px">Ajouter le produit</button>
                                    </div>
                                    <div class="card text-start mt-3">
                                        <div class="card-body bg-light-subtle">
                                            <div class="table-responsive">
                                                <div class="datatable-wrapper datatable-loading no-footer sortable fixed-height fixed-columns">
                                                    <div class="datatable-container" {{-- style="height: 665.531px;" --}}>
                                                        <table class="table table-bordered datatable datatable-table Table_Tmp_Marchandis_Entree w-100"  >
                                                            <thead>
                                                                <tr>
                                    ...
                                    <div class="card m-auto p-3 bg-light">
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-md-4 col-12 d-flex justify-content-md-end justify-content-center mt-2">
                                                <button class="btn btn-success" id="AddInTmpMarchandiseEntree" style="max-height: 40px">
                                                    Ajouter le produit
                                                </button>
                                            </div> --}}
                                        </div>
