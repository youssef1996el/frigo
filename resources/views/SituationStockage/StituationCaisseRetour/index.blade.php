        ...
        <section class="mt-3">
            <div class="row bg-light p-2 rounded-2 border">
                <div class="col-sm-12 col-md-6 col-xl-6">
                    <h3 class="">Table Retour de  Marchandises</h3>
                </div>
                <div class="col-sm-12 col-md-6 col-xl-6">
            ...
            <form action="{{url('Stituation_SortieCaisseRetour')}}" method="get">
                <div class="row  mb-3">
                ...
                <table class="table table-striped table-bordered" id="my-table">
                    ...
                    <tbody>
                        @foreach ($dataCaisseRetour as $date => $clientsData)
                            <tr>
                                ...
                                @endforeach
                                <td class="text-center">{{ intval($sumByDate[$date]) }}</td>
                                {{-- <td class="text-center">{{ intval($sumCumlByDate[$date]) }}</td> --}}
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            @endforeach
                            <td class=" text-dark text-center">{{ $totalSum }}</td>
                            {{-- <td class="bg-success text-white text-center">{{ $totalCuml }}</td> --}}
                        </tr>
                    </tfoot>
                </table>
