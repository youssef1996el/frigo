        ...
        <section class="mt-3">
            <div class="row bg-light p-2 rounded-2 border">
                <div class="col-sm-12 col-md-6 col-xl-6">
                    <h3 class="">Table Sortie de  Marchandises</h3>
                </div>
                <div class="col-sm-12 col-md-6 col-xl-6">
            ...
            <form action="{{url('Stituation_MarchandiseSortie')}}" method="get">
                <div class="row  mb-3">
                ...
                <table class="table table-striped table-bordered" id="my-table">
                    ...
                    <tbody>
                        @foreach ($dataMarchSortie as $date => $clientsData)
                            <tr>
                                ...
                                @endforeach
                                <td class="text-center">{{ intval($totalsMarchSortie[$date]['totalNombre']) }}</td>
                                {{-- <td class="text-center">{{ intval($totalsMarchSortie[$date]['totalCuml']) }}</td> --}}
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            @endforeach
                            <td class=" text-dark text-center">{{ $totalsMarchSortie['grandTotalNombre'] }}</td>
                            {{-- <td class="bg-success text-white text-center">{{ $totalsMarchSortie['grandTotalCuml'] }}</td> --}}
                        </tr>
                    </tfoot>
                </table>
