        ...
        <section class="mt-3">
            <div class="row bg-light p-2 rounded-2 border">
                <div class="col-sm-12 col-md-6 col-xl-6">
                    <h3 class="">Table  Sortie de caisses vides</h3>
                </div>
                <div class="col-sm-12 col-md-6 col-xl-6">
            ...
            <form action="{{url('Stituation_SortieCaisseVide')}}" method="get">
                <div class="row  mb-3">
                            ...
                            <tbody>
                                @foreach ($dataCaisseVide as $date => $clientsData)
                                    <tr>
                                        ...
                                        @endforeach
                                        <td class="text-center">{{ intval($totalsCaisseVide[$date]['totalNombre']) }}</td>
                                        {{-- <td class="text-center">{{ intval($totalsCaisseVide[$date]['totalCuml']) }}</td> --}}
                                    </tr>
                                @endforeach
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    @foreach ($clientsCaisseVide as $client)
                                        @php
                                            $sumNombre = 0;
                                            $sumCuml = 0;
                                            foreach ($dataCaisseVide as $clientsData) {
                                    ...
                                    @endforeach
                                    <td class=" text-dark text-center">{{ $totalsCaisseVide['grandTotalNombre'] }}</td>
                                    {{-- <td class="bg-success text-white text-center">{{ ($totalsCaisseVide['grandTotalCuml']) }}</td> --}}
                                </tr>
                            </tfoot>
                        </table>
                    </div>
