...
<html lang="en">
    ...
    <body data-menu-color="light" data-sidebar="hidden">
        ...
        <div id="app-layout">
            ...
            <!-- Left Sidebar Start -->
            <div class="app-sidebar-menu" hidden>
                <div class="h-100" data-simplebar>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li class="menu-title">Compagnies</li>

                            <li>
                                <a class='tp-link' href="{{url('company')}}" >
                            ...
                            <li>
                                <a  class='tp-link' href="{{url('caissesortie')}}" >
                                    <i data-feather="package" ></i>
                                    <span> Sortie de caisses vides </span>
                                </a>
                                
                                
                            </li>
                            <li>
                                <a class='tp-link' href="{{url('MarchandisEntre')}}">
                                    <i data-feather="package"></i>
                                    <span> Entrée de marchandises </span>
                                </a>
                            </li>
                            <li>
                                <a class='tp-link' href="#sidebarBaseui" >
                                    <i data-feather="package"></i>
                                    <span> Sortie de marchandises </span>
                                </a>
                            </li>
                            <li>
                                <a class='tp-link' href="#sidebarBaseui" >
                                    <i data-feather="package"></i>
                                    <span> Retour de caisses vides </span>
                                </a>
                            </li>
                            ...
                            <li class="menu-title mt-2">Livreurs</li>

                            <li>
                                <a class='tp-link' href="{{url('livreur')}}" >
                                    <span class="mdi mdi-truck-delivery"></span>
                                    <span> List de Livreur </span>
                                </a>
                            </li>

                            <li class="menu-title mt-2"> produits</li>

                            <li>
                                <a href="{{url('ListOrigin')}}" >
                                    <span class="mdi mdi-fruit-pineapple"></span>
