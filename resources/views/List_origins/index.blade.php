...
@section('dashboard')
<script src="{{asset("public/js/ListOrigins/script.js")}}"></script>
                            ...
                            <div class=" mb-3">
                               <div class="row g-2">
                                    <div class="col-12 col-lg-4">
                                        <button class="btn btn-primary w-100 w-lg-auto" data-bs-toggle="modal" data-bs-target="#ModalAddProduct">
                                            Ajouter un produit
                                        </button>
                                    </div>
